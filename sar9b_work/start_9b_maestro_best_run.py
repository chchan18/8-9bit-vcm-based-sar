#!/usr/bin/env python3
"""Start the real 9-bit Maestro run for ADC_9B_tb_best_q4."""
...
from prepare_9b_maestro_best import LIB, OUT_DIR, SCALED_BINARY_Q4, TB_CELL, TOP_CELL
...
let((cv i0 i14 i15 out)
  ...
  unless(cv error("cannot open 9-bit TB schematic"))
...
def main() -> None:
    ...
    print(f"Started real 9-bit Maestro run for {LIB}/{TB_CELL}", flush=True)
